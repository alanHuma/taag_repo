...
/* harmony import */ var _Applications_XAMPP_xamppfiles_htdocs_taag_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/objectSpread2 */ "./node_modules/@babel/runtime/helpers/esm/objectSpread2.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getIndex: function getIndex() {
      ...
      this.items = [];
      axios__WEBPACK_IMPORTED_MODULE_3___default().get("https://api.airtable.com/v0/".concat(airTableApp, "/").concat(airTableName), {
        headers: {
          Authorization: "Bearer " + apiToken
        }
      }).then(function (response) {
        _this.items = response.data.records.map(function (item) {
          return (0,_Applications_XAMPP_xamppfiles_htdocs_taag_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__["default"])({
            id: item.id
          }, item.fields);
        });
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default().get('api/books', [], {
        headers: {
